...
interface Props {
  ...
  previewStyle?: string | Record<string, string>
  recent?: boolean
  free?: boolean
}
...
const blockView = ref<number>(0)
const codeCopied = ref<boolean>(false)
const codeCopyLoading = ref<boolean>(false)

function activateView(event: Event, blockViewValue: number): void {
