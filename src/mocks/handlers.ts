...
const productsWithOrdersData: ProductWithOrders[] = [
      {
        id: '1000',
        code: 'f230fh0g3',
        name: 'Bamboo Watch',
...
const treeTableNodesData: TreeTableNode[] = [
      {
        key: '0',
        data: {
          name: 'Applications',
...
export const handlers = [
  ...
  http.get('/api/products/with-orders', () => {
    return HttpResponse.json(productsWithOrdersData)
  }),
  http.get('/api/customers', () => {
    return HttpResponse.json(customersData)
  }),
  http.get('/api/countries', () => {
    return HttpResponse.json(countriesData)
  }),
  http.get('/api/photos', () => {
    return HttpResponse.json(photosData)
  }),
  http.get('/api/nodes/tree', () => {
    return HttpResponse.json(treeNodesData)
  }),
  http.get('/api/nodes/tree-table', () => {
    return HttpResponse.json(treeTableNodesData)
  }),
]