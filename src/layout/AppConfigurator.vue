...
const presetOptions = ref<(keyof typeof presets)[]>(
...
type Surface = { name: string; palette: Record<string, string> }

function updateColors(type: 'primary' | 'surface', color: PrimaryColor | Surface) {
  if (!color) return
  if (type === 'primary') {
...
function applyTheme(type: 'primary' | 'surface', color: PrimaryColor | Surface) {
  if (!color) return
  if (type === 'primary') {
      ...
      <div>
        ...
        <div class="pt-2 flex gap-2 flex-wrap justify-between">
          <button
            ...
            @click="updateColors('primary', primaryColor as PrimaryColor)"
            :class="[
